...
$SQL['pass']="";//pass
$SQL['base']="database";//nom de la base de données
?><!DOCTYPE HTML>
<html>
    <head>
        ...
        if(isset($_GET['code'],$_GET['mail'])){
            ...
            if(!$mysqli) {
                ...
                if(mysqli_num_rows($req)==1){
                    ...
                    mysqli_query($mysqli,"UPDATE users SET password='".md5($NouveauPass)."' WHERE email='$Mail'");
                ...
                if(empty($_POST['mail'])){
                    ...
                    if(!$mysqli) {
                        ...
                        if(mysqli_num_rows($req)!=1){
                            ...
                            $Lien=$_SERVER['HTTP_HOST']."/oublie.php?code=$Code&mail=$Mail";
