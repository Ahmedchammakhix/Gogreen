...
?>
													...
													<div class="stat-panel-title text-uppercase">nombre d'utilisateurs </div>
												</div>
											</div>
											<a href="userlist.php" class="block-anchor panel-footer">plus de Details <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
											...
											<a href="feedback.php" class="block-anchor panel-footer text-center">plus de Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>
											...
											<a href="notification.php" class="block-anchor panel-footer text-center">plus de Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
													...
													<div class="stat-panel-title text-uppercase">Utilisateurs effacés </div>
												</div>
											</div>
											<a href="deleteduser.php" class="block-anchor panel-footer text-center">plus de Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
