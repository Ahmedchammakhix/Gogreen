        ...
        <div class="container">
            <article class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="tab-pane shop-grid">
                        
                        <div class="product__box product__default--single text-center">
                          <li>
                  <div class="product__img-box  pos-relative"> <tr>  
                    
                      <img src="assets/img/bio/<?php echo $produit["img"]; ?>" length="80" height="180" alt="chef img">
                    ...
                    echo  $cat->Typejeux;
                    ?> </h4>
                      <h4></i><?PHP echo $produit['Nomjeux'];?> </h4>
                       <h4></i><?PHP echo $produit['prix']; ?> $ </h4>
                    ...
                    <form action="ajouterpanier.php" method="GET">
                              ...
                              <button class="btn btn--box btn--radius btn--small btn--black btn--black-hover-green btn--uppercase font--bold">ajouter panier</button> 
