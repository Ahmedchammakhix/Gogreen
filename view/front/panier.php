                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between align-items-center">
                                                ...
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="bio.php" class="mega-menu__link">PRODUCTSS</a></li>
                            ...
                            <ul class="header__user-action-icon">
                                ...
                                <li>
                                    <a afficherlignecommande.php class="offcanvas-toggle">
                ...
                <div class="container">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-3">
                            <div class="header-phone text-end"><span>Call Us:+216 93 456 543</span></div>
                        </div>
                    </div>
                </div>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="product.php">Grid Left Sidebar</a></li>
        ...
        <div class="col-md-12">
          <div class="mu-restaurant-game-area">
            ...
            <div class="mu-title">
              ...
              <h2 class="section-content__title">Your cart item</h2>           
                 <h3 class="title title--normal title--thin m-tb-30"> <?php  if ($N==0) echo "Commande(s) bien validée(s)!!!"?></h3>
                    <?php    if ($N>0) { ?>     <h2 class="section-heading text-uppercase" style="position: relative;right: 100px;">(<?php  echo $N; ?>)PRODUITS</h2>   <?php    } ?> 
                </div>
...
foreach ($listpanier as $row)
{
 ...
 ?>
               ...
               <td valign="middle"><center><img width="200px" src="assets/img/bio/<?php echo $row['imgproduit'];?>" /></center></td>
        <th><center><h5 style="position: relative;top: 50px"><?php echo $row['nomproduit'];?></h5></center></th>
            ...
            <td align="center">
             <center>  <form action="modifierpanier.php" method="post" style="position: relative;top: 15px">
    ...
    <center>  <button type="submit" class="btn btn--medium btn--radius btn--transparent btn--border-black btn--border-black-hover-green font--light text-uppercase">update</button>
               </form></center>
           </td>
  ...
  ?>
        ...
        <center><div style="position: relative;left: 400px" class="col-lg-4 col-md-6">
                    <div class="sidebar__widget m-t-40">
                        <div class="sidebar__box">
                            <h5 class="sidebar__title">Cart Total</h5>
                        </div>
                        <h6 class="total-cost">Total products Price<span><?php echo  $S1.' '.'TND' ?></span></h6>
...
<form action="ajoutercommande.php"  action="supprimertout.php"    method="post">
          ...
          <input type="hidden" id="client" name="client" value="<?php echo  $row["client"] ?> ">
                    ...
                    <button class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold" type="submit">PASSER COMMANDE</button>
