                                                ...
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="shop-sidebar-grid-left.html" class="mega-menu__link">Commandes</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
         ...
         <th scope="col"style="font-weight: 1000;font-size: 15px"><center>nom de commande</center></th>
            ...
            <th scope="col"style="font-weight: 1000;font-size: 15px"><center>Cancel</center></th>
            <th scope="col"style="font-weight: 1000;font-size: 15px"><center>Print</center></th>
...
foreach ($listcommande as $row)
{
 ...
 ?>    
        ...
        <tr valign="middle">
            ...
            <td align="center"><?php echo $row["prix_tot"].' '.'$' ?></td>
          ...
          <center> <form action="supprimerlignecommande.php" method="get">
               ...
               <input type="hidden" id="id_commande" name="id_commande" value="<?php echo $row["id_commande"] ?>">
                  ...
                  <input type="hidden" id="etat" name="etat" value="<?php echo $row["etat"] ?>">
                   <button  class="btn btn-light" type="submit" ><span class="fas fa-cloud-download-alt"></span></button></td>
                </form></center>
