...
if($lastInsertId)
{
echo "<script type='text/javascript'>alert('Parfait!');</script>";
echo "<script type='text/javascript'> document.location = 'index.php'; </script>";
}
else 
{
$error="ya quelque chose qui cloche";
}
	...
	function validate()
        {
            ...
            alert("Extension d'Image non Valide (essayez Jpg,jpeg)");
            return false;
        }
	...
	<div class="login-page bk-img">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 class="text-center text-bold mt-2x">Creer un compte</h1>
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <label class="col-sm-1 control-label">votre metier<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            <input type="text" name="designation" class="form-control" required>
                             ...
                             <div class="form-group">
                            <label class="col-sm-1 control-label">Sexe<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            ...
                            <label class="col-sm-1 control-label">numero tel<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            ...
                            <div><input type="file" name="image" class="form-control"></div>
								...
								<br>
                                <button class="btn btn-primary" name="submit" type="submit">s'enregistrer</button>
                                </form>
                                <br>
                                <br>
								<p>vous avez deja un compte ? <a href="index.php" >Signin</a></p>
							</div>
						</div>
				</div>
			</div>
